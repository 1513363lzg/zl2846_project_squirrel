...
def squirrel_stats(request):
    ...
    sightings_stats2=Squirrel.objects.filter(PRIMARYFURCOLOR_CHOICES='Black').count()
    sightings_stats3=Squirrel.objects.filter(PRIMARYFURCOLOR_CHOICES='Gray').count()
