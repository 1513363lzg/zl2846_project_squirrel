# Generated by Django 2.2.7 on 2019-12-08 18:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Latitude', models.DecimalField(decimal_places=20, help_text='Latitude of squirrel', max_digits=30, null=True)),
                ('Longitude', models.DecimalField(decimal_places=20, help_text='Longitude of squirrel', max_digits=30, null=True)),
                ('Unique_squirrel_ID', models.CharField(help_text='Unique squirrel id', max_length=50, null=True)),
                ('Hectare', models.CharField(help_text='Hectare of squirrel,like 32D', max_length=10, null=True)),
                ('Shift', models.CharField(choices=[('AM', 'AM'), ('PM', 'PM')], default='AM', help_text='Shift of squirrel', max_length=15, null=True)),
                ...
                ('Age', models.CharField(choices=[('Adult', 'Adult'), ('Juvenile', 'Juvenile')], default=False, help_text='Age of squirrel', max_length=15)),
                ('Primary_fur_color', models.CharField(choices=[('Gray', 'Gray'), ('Black', 'Black'), ('Cinnamon', 'Cinnamon')], default=False, help_text='Primary fur color of squirrel', max_length=20)),
                ('Location', models.CharField(choices=[('Ground Plane', 'Ground Plane'), ('Above Ground', 'Above Ground')], default=False, help_text='location of squirrel', max_length=20)),
                ('Specific_location', models.CharField(default=False, help_text='Specific location of squirrel', max_length=100)),
